...
import type { RollingWellnessPoint } from '@/types'
...
interface RollingWellnessChartProps {
  data: RollingWellnessPoint[]
}

export function RollingWellnessChart({ data }: RollingWellnessChartProps) {
  if (data.length < 2) {
    return (
